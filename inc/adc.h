...
/*!******************************************************************
 * \fn ADC_status_t ADC_compute_mcu_voltage(int32_t adc_channel_vbat_12bits, int32_t* mcu_voltage_mv)
 * \brief Compute MCU voltage.
 * \param[in]   adc_channel_vbat_12bits_12bits: VBAT channel 12-bits raw data from ADC.
...
#ifdef STM32G4XX_DRIVERS_ADC_VREF_MV
/*!******************************************************************
 * \fn ADC_status_t ADC_compute_mcu_temperature(int32_t_t mcu_temperature_12bits, int32_t* mcu_temperature_degrees)
...
#else
/*!******************************************************************
 * \fn ADC_status_t ADC_compute_mcu_temperature(int32_t vref_mv, int32_t_t mcu_temperature_12bits, int32_t* mcu_temperature_degrees)
 * \brief Compute MCU temperature.
...
/*!******************************************************************
 * \fn ADC_status_t ADC_get_master_dr_register_address(ADC_instance_t instance, uint32_t* dr_register_address)
...
/*!******************************************************************
 * \fn ADC_status_t ADC_get_slave_dr_register_address(ADC_instance_t instance, uint32_t* dr_register_address)
