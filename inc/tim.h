...
#define TIM_MODE_MASK_CAPTURE       0x20

#define TIM_MODE_MASK_ALL           0x3F
...
typedef enum {
    ...
    TIM_ERROR_MODE,
    TIM_ERROR_INPUT_CLOCK,
    TIM_ERROR_INPUT_CLOCK_NOT_SUPPORTED,
    TIM_ERROR_UNIT,
    TIM_ERROR_ARR_VALUE,
...
/*!******************************************************************
 * \enum TIM_capture_prescaler_t
 * \brief Timer capture prescalers list.
 *******************************************************************/
typedef enum {
    TIM_CAPTURE_PRESCALER_NONE = 0,
    TIM_CAPTURE_PRESCALER_2,
    TIM_CAPTURE_PRESCALER_4,
    TIM_CAPTURE_PRESCALER_8,
    TIM_CAPTURE_PRESCALER_LAST
} TIM_capture_prescaler_t;
...
#if ((STM32G4XX_DRIVERS_TIM_MODE_MASK & TIM_MODE_MASK_STANDARD) != 0)
/*!******************************************************************
 * \fn TIM_status_t TIM_STD_start(TIM_instance_t instance, RCC_clock_t input_clock, uint32_t period_value, TIM_unit_t period_unit, TIM_completion_irq_cb_t irq_callback)
 * \brief Start a timer in standard mode.
 * \param[in]   instance: Timer instance to use.
 * \param[in]   input_clock: Timer input clock (SYSTEM or LSE for some instances).
...
/*!******************************************************************
 * \fn TIM_status_t TIM_IC_init(TIM_instance_t instance, TIM_gpio_t* pins)
 * \brief Init a timer peripheral in capture mode.
 * \param[in]   instance: Timer instance to use.
 * \param[in]   pins_list: List of timer pins to configure.
 * \param[out]  none
 * \retval      Function execution status.
...
#if ((STM32G4XX_DRIVERS_TIM_MODE_MASK & TIM_MODE_MASK_CAPTURE) != 0)
/*!******************************************************************
 * \fn TIM_status_t TIM_IC_de_init(TIM_instance_t instance, TIM_gpio_t* pins)
 * \brief Release a timer peripheral.
 * \param[in]   instance: Timer instance to release.
 * \param[in]   pins: List of timer pins to release.
 * \param[out]  none
...
#if ((STM32G4XX_DRIVERS_TIM_MODE_MASK & TIM_MODE_MASK_CAPTURE) != 0)
/*!******************************************************************
 * \fn TIM_status_t TIM_IC_start_channel(TIM_instance_t instance, TIM_channel_t channel, uint32_t sampling_frequency_hz, TIM_capture_prescaler_t capture_prescaler)
 * \brief Start a capture.
 * \param[in]   instance: Timer instance to use.
 * \param[in]   channel: Channel to start.
 * \param[in]   sampling_frequency_hz: Timer clock frequency.
...
#if ((STM32G4XX_DRIVERS_TIM_MODE_MASK & TIM_MODE_MASK_CAPTURE) != 0)
/*!******************************************************************
 * \fn TIM_status_t TIM_IC_stop_channel(TIM_instance_t instance, TIM_channel_t channel)
