...
typedef enum {
    ...
    RCC_ERROR_PLL_CLOCK_SOURCE,
    RCC_ERROR_PLL_CLOCK_SOURCE_READY,
    RCC_ERROR_PLL_M,
    RCC_ERROR_PLL_INPUT_CLOCK_FREQUENCY_UNDERFLOW,
    RCC_ERROR_PLL_INPUT_CLOCK_FREQUENCY_OVERFLOW,
    RCC_ERROR_PLL_N,
    RCC_ERROR_PLL_VCO_CLOCK_FREQUENCY_UNDERFLOW,
    RCC_ERROR_PLL_VCO_CLOCK_FREQUENCY_OVERFLOW,
    RCC_ERROR_PLL_R,
    RCC_ERROR_PLL_P,
    RCC_ERROR_PLL_Q,
    RCC_ERROR_PLL_OUTPUT_CLOCK_OVERFLOW,
    RCC_ERROR_PLL_READY,
...
/*!******************************************************************
 * \struct RCC_pll_configuration_t
...
/*!******************************************************************
 * \fn RCC_status_t RCC_switch_to_pll(RCC_pll_configuration_t* pll_configuration)
 * \brief Switch system clock to PLL.
 * \param[in]   pll_configuration: Pointer to the PLL parameters structure.
 * \param[out]  none
 * \retval      Function execution status.
 *******************************************************************/
